...
export const landings: Landing[] = [
...

  {
    ...
    kind: 'service',
    title: 'AI Systems for Philippine Businesses | Beyond Chatbots',
    description:
      'AI systems that qualify and route leads, score them, automate follow-up and CRM, and keep reporting honest - for Philippine businesses. Not just a chatbot.',
    eyebrow: 'AI systems',
    h1: 'AI that runs the parts',
    h1Accent: 'nobody has time for.',
    lede:
      'A chatbot is one small piece. The real work is everything around it: qualifying and routing every enquiry, scoring which are worth chasing first, running the follow-up nobody remembers, keeping the CRM current, and producing reporting that does not depend on someone rebuilding a spreadsheet each month.',
    painTitle: 'Where the time and money actually go',
    pain: [
      'Enquiries arrive after hours and sit unanswered until morning.',
      'Your best salesperson spends their day on leads that were never going to buy.',
      'Nobody follows up a second time, and most conversions need a second touch.',
      'The CRM is out of date because updating it is somebody\u2019s least favourite job.',
      'Monthly reporting means someone rebuilding the same spreadsheet, late, by hand.',
      'Leads sit in whoever happened to receive them, with no routing and no ownership.',
    ],
    approachTitle: 'What we build',
    approach: [
      { n: '01', title: 'Qualification and routing', body: 'Budget, location, timeline and intent established automatically, then the lead routed to the right person - not left in whichever inbox caught it.' },
      { n: '02', title: 'Lead scoring', body: 'Every enquiry ranked on how likely it is to close, so your team works the top of the list instead of the top of the inbox.' },
      { n: '03', title: 'Instant response', body: 'A reply within seconds, in the language the customer used, that answers the actual question instead of posting a menu.' },
      { n: '04', title: 'Follow-up sequences', body: 'The second, third and fourth touch that almost never happens manually - scheduled, personalised and sent without anyone remembering.' },
      { n: '05', title: 'CRM and pipeline automation', body: 'Records created and updated as conversations happen, so the pipeline reflects reality without anyone doing data entry.' },
      { n: '06', title: 'Reporting that builds itself', body: 'Spend, cost per lead, conversion and pipeline pulled together automatically, so the monthly report is a review rather than a reconstruction.' },
      { n: '07', title: 'Honest guardrails', body: 'The system answers what it reliably knows and escalates what it does not. A confidently wrong answer costs more trust than a short wait.' },
    ],
    proof:
      'Built as part of our managed engagements, alongside the campaigns generating the enquiries - so acquisition and the systems that handle it are designed together rather than bolted on afterwards.',
    faqs: [
      ...
      { q: 'Which channels does this cover?', a: 'Primarily Facebook Messenger and Viber, since that is where Philippine buyers actually message. Website chat, email and SMS sit alongside them, and the routing, scoring and CRM layers work across all of them.' },
      { q: 'Does this only work if we run ads with you?', a: 'No. The systems sit on whatever is generating enquiries - ads, organic, referral, walk-in. They are most valuable when volume is high, which is usually when ads are running, but they are not tied to it.' },
      { q: 'Do we need a CRM already?', a: 'It helps, but no. If you have one we automate into it. If you do not, we will set up something proportionate rather than sell you enterprise software you will never fully use.' },
